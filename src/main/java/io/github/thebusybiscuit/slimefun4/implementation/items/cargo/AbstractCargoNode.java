    ...
    protected void addChannelSelector(Block b, BlockMenu menu, int slotPrev, int slotCurrent, int slotNext) {
        ...
        menu.replaceExistingItem(
                ...
                new CustomItemStack(
                        ...
                        "&bPředchozí kanál",
                        "",
                        "&e> Klikni pro snížení ID kanálu o 1"));
        ...
        if (channel == 16) {
            menu.replaceExistingItem(
                    slotCurrent,
                    new CustomItemStack(
                            HeadTexture.CHEST_TERMINAL.getAsItemStack(), "&bID kanálu: &3" + (channel + 1)));
            menu.addMenuClickHandler(slotCurrent, ChestMenuUtils.getEmptyClickHandler());
        } else {
            menu.replaceExistingItem(
                    slotCurrent,
                    new CustomItemStack(ColoredMaterial.WOOL.get(channel), "&bID kanálu: &3" + (channel + 1)));
            menu.addMenuClickHandler(slotCurrent, ChestMenuUtils.getEmptyClickHandler());
        }
        ...
        menu.replaceExistingItem(
                ...
                new CustomItemStack(
                        ...
                        "&bDalší kanál",
                        "",
                        "&e> Klikni pro zvýšení ID kanálu o 1"));
