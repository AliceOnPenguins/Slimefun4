...
public class ProduceCollector extends AContainer implements RecipeDisplayItem {
    ...
    public @Nonnull List<ItemStack> getDisplayRecipes() {
        ...
        displayRecipes.add(new CustomItemStack(Material.BUCKET, null, "&fPro výrobu potřebuje v okolí &bkrávu"));
        displayRecipes.add(new ItemStack(Material.MILK_BUCKET));

        if (Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_17)) {
            displayRecipes.add(new CustomItemStack(Material.BUCKET, null, "&fPro výrobu potřebuje v okolí &bkozu"));
            displayRecipes.add(new ItemStack(Material.MILK_BUCKET));
        }

        displayRecipes.add(new CustomItemStack(Material.BOWL, null, "&fPro výrobu potřebuje v okolí &bhoubovou krávu"));
