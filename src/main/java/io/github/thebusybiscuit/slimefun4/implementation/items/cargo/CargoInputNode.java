        ...
        if (roundRobinMode == null || roundRobinMode.equals(String.valueOf(false))) {
            menu.replaceExistingItem(
                    ...
                    new CustomItemStack(
                            ...
                            "&7Round-robin režim: &4\u2718",
                            "",
                            "&e> Klikni pro zapnutí round-robin režimu",
                            "&e(položky budou rovnoměrně rozděleny mezi kanály)"));
            ...
            menu.replaceExistingItem(
                    ...
                    new CustomItemStack(
                            SlimefunUtils.getCustomHead(HeadTexture.ENERGY_REGULATOR.getTexture()),
                            "&7Round-robin režim: &2\u2714",
                            "",
                            "&e> Klikni pro vypnutí round-robin režimu",
                            "&e(položky budou rovnoměrně rozděleny mezi kanály)"));
            menu.addMenuClickHandler(24, (p, slot, item, action) -> {
        ...
        if (smartFillNode == null || smartFillNode.equals(String.valueOf(false))) {
            menu.replaceExistingItem(
                    ...
                    new CustomItemStack(
                            ...
                            "&7Režim \"chytrého doplňování\": &4\u2718",
                            "",
                            "&e> Klikni pro zapnutí",
                            "",
                            "&fPo zapnutí se cargo uzel pokusí",
                            "&fudržovat určité množství položek v cargo síti",
                            "&ftato funkce ale není dokonalá",
                            "&fstále se pokusí zaplnit prázdná místa před hromadou předmětů"));
            ...
            menu.replaceExistingItem(
                    ...
                    new CustomItemStack(
                            ...
                            "&7Režim \"chytrého doplňování\": &2\u2714",
                            "",
                            "&e> Klikni pro vypnutí",
                            "",
                            "&fPo zapnutí se cargo uzel pokusí",
                            "&fudržovat určité množství položek v cargo síti",
                            "&ftato funkce ale není dokonalá",
