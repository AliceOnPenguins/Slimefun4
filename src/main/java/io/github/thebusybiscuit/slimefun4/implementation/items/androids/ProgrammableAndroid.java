...
public class ProgrammableAndroid extends SlimefunItem
    ...
    public ProgrammableAndroid(
        ...
        new UniversalMenuPreset(getId(), "Programovatelný android") {
            ...
            public void newInstance(UniversalMenu menu, Block b) {
                ...
                menu.replaceExistingItem(
                        15, new CustomItemStack(HeadTexture.SCRIPT_START.getAsItemStack(), "&aSpustit/pokračovat"));
                ...
                menu.replaceExistingItem(
                        17, new CustomItemStack(HeadTexture.SCRIPT_PAUSE.getAsItemStack(), "&4Pozastavit"));
                ...
                menu.replaceExistingItem(
                        ...
                        new CustomItemStack(
                                ...
                                "&bPaměťové jádro",
                                "",
                                "&8\u21E8 &7Klikni pro otevření editoru skriptu"));
    ...
    public void openScript(Player p, SlimefunUniversalBlockData uniData, String sourceCode) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7\u21E8 &eLevé tlačítko &7návrat na ovládací panel androida"));
        ...
        for (int i = 1; i < script.length; i++) {
            ...
            if (i == script.length - 1) {
                ...
                if (hasFreeSlot) {
                    menu.addItem(
                            i, new CustomItemStack(HeadTexture.SCRIPT_NEW.getAsItemStack(), "&7> Přidat nový příkaz"));
                                        ...
                                        .getMessage(
                                                ...
                                                "android.scripts.instructions."
                                                        + Instruction.valueOf(script[i])
                                                                .name()),
                                "",
                                "&7\u21E8 &eLevé tlačítko &7Upravit",
                                "&7\u21E8 &ePravé tlačítko &7Smazat",
                                "&7\u21E8 &eShift + pravé tlačítko &7Kopírovat"));
                menu.addMenuClickHandler(i, (pl, slot, item, action) -> {
    ...
    protected void openScriptDownloader(Player p, SlimefunUniversalBlockData uniData, int page) {
        ChestMenu menu = new ChestMenu("Skript androida");
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&eNahrát skript",
                        "",
                        "&6Klikni &7pro nahrání skriptu,",
                        "&7který právě používáš, na server"));
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&6> Zpět",
                        "",
                        "&7Návrat na ovládací panel androida"));
    ...
    public void openScriptEditor(Player p, SlimefunUniversalBlockData uniData) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&2> Upravit skript",
                        "",
                        "&aUpravit svůj stávající skript"));
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&4> Vytvořit nový skript",
                        "",
                        "&cSmaže skript, který právě používáš,",
                        "&ca vytvoří zcela nový prázdný skript"));
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "&6> Stáhnout skript",
                        "",
                        "&eStáhni ze serveru skript nahraný jiným hráčem",
                        "&eMůžeš ho použít hned, nebo si ho nejdřív upravit"));
    ...
    protected void editInstruction(Player p, SlimefunUniversalBlockData uniData, String[] script, int index) {
        ...
        menu.addItem(
                9,
                new CustomItemStack(HeadTexture.SCRIPT_PAUSE.getAsItemStack(), "&fNedělat nic"),
                (pl, slot, item, action) -> {
                    String code = deleteInstruction(script, index);
                    setScript(uniData, code);
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        for (MachineFuel fuel : fuelTypes) {
            ...
            lore.add(ChatColors.color("&8\u21E8 &7Zbývá " + NumberUtils.getTimeLeft(fuel.getTicks() / 2)));
            im.setLore(lore);
            item.setItemMeta(im);
            list.add(item);
        }
