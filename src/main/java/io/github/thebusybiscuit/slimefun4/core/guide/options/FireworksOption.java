    ...
    public Optional<ItemStack> getDisplayItem(Player p, ItemStack guide) {
        ...
        if (cfgManager.isResearchingEnabled() && cfgManager.isResearchFireworkEnabled()) {
            ...
            ItemStack item = new CustomItemStack(
                    ...
                    "&bEfekt ohňostroje: &" + (enabled ? "aZapnut" : "4Vypnut"),
                    "",
                    "&7Nyní si můžeš zvolit,",
                    "&7zda chceš při odemknutí",
                    "&7nového předmětu zobrazit",
                    "&7efekt ohňostroje.",
                    "",
                    "&7\u21E8 &eKlikni pro " + (enabled ? "vypnutí" : "zapnutí") + " efektu ohňostroje");
