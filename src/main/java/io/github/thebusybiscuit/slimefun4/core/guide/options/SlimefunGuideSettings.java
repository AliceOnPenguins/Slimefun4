    ...
    private static void addHeader(Player p, ChestMenu menu, ItemStack guide) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&fPůvodní čínská lokalizace: StarWishsama",
                        "&cProsím nedávej snímek obrazovky s touto verzí na Discord/Github při hlášení chyby",
                        "&cradši to nahlas na stránce lokalizace",
                        "",
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Naposledy aktivní: &a" + NumberUtils.getElapsedTime(github.getLastUpdate()) + " zpět",
                        "&7Forks: &e" + github.getForks(),
                        "&7Stars: &e" + github.getStars(),
                        "",
                        "&7&oSlimefun 4 je komunitní projekt,",
                        "&7&ozdrojový kód najdeš na GitHubu",
                        "&7&opokud chceš, aby tento projekt pokračoval,",
                        "&7&omůžeš zvážit přispění do projektu",
                        "",
                        "&7\u21E8 &eKlikni pro přechod na GitHub repozitář této lokalizace"));
        // @formatter:on
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Potřebuješ pomoc s předměty nebo stroji?",
                        "&7Nevíš, co dělat?",
                        "&7Podívej se na naši komunitní Wiki",
                        "&7a zvaž, že se staneš editorem!",
                        "",
                        "&7\u21E8 &eKlikni pro přechod na Wiki"));
        // @formatter:on
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&7Slimefun je rozsáhlý projekt, ale existence addonů",
                        "&7mu umožňuje opravdu zazářit",
                        "&7podívej se na ně, možná je tam addon, který hledáš!",
                        "",
                        "&7Na tomto serveru je nainstalováno addonů: &b"
                                + Slimefun.getInstalledAddons().size(),
                        "",
                        "&7\u21E8 &eKlikni pro zobrazení dostupných addonů pro Slimefun4"));
        // @formatter:on
