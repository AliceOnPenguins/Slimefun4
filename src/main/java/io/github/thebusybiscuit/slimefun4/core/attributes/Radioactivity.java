...
public enum Radioactivity {
     ...
     */
    VERY_DEADLY(ChatColor.DARK_RED, "Smrtelná", 10);
    ...
    public @Nonnull String getLore() {
        return ChatColor.GREEN + "\u2622" + ChatColor.GRAY + " Úroveň radiace: " + color + displayName;
    }
